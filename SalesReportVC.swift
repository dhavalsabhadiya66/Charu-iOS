...
class SalesReportVC: UIViewController, UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, AppNavigationControllerDelegate, JDSelectionDelegate {
...
//        self.tfToDate.text = dateFormatter.string(from: toDate)
    ...
    func setUpNavigationBar(){
        Obj_AppDelegate.navigationController.setCustomTitle("Sales Report")
    ...
    func appNavigationController_RightMenuAction() {
        ...
        var data = ""
        data += "<TABLE border=\"1\">"
        data += "<TR><td align='center' colspan=\"15\"><b>Sales Report</b></td>";
        data += "</TR>";
        ...
        data += "<TH align='center' style=\"white-space: nowrap;font-size:10px; \"><b>Sale Rate</b></TH>";
        data += "<TH align='center' style=\"white-space: nowrap;font-size:10px; \"><b>Sale Amount</b></TH>";
        data += "</TR>";
        var srNo = 0
        ...
        let filePath = "\(directory)/saleReport.pdf"
...
//                DesignModel.showMessage(errStr, for: self)
    ...
    func getReportData(){
        ...
        Obj_OperationApi.callWebService(ApiMethod.SalesReport, method: .post, parameters: params, onCompletion: { (responce) in
            print(responce)
            if self.pageNo == 1 {
